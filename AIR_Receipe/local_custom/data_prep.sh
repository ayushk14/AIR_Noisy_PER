...
cp -a ~/AIR_Noisy_PER/train.text $AIR_dataset_dir/Kannada_Dataset/train.text
cp -a ~/AIR_Noisy_PER/test.text $AIR_dataset_dir/Kannada_Dataset/test.text
cp -a ~/AIR_Noisy_PER/lexicon.txt $AIR_dataset_dir/Kannada_Dataset/dict_files/lexicon.txt
cp -a ~/AIR_Noisy_PER/phones.txt $AIR_dataset_dir/Kannada_Dataset/dict_files/phones.txt
